...
function crearMensajeHTML(mensaje, personaje, foto) {
...
postBtn.on('click', function() {
    ...
    crearMensajeHTML( mensaje, usuario, foto );
    ...
    fetch("/api")
        ...
        .then(datos => {
            ...
            datos.forEach(mensaje => {
                crearMensajeHTML( mensaje.mensaje, mensaje.user, mensaje.foto );
            });
        });
...
btnDesactivadas.on( 'click', () => {
    console.log("notificaiones activadas")
...
btnActivadas.on('click', function() {
    console.log("notificaiones Desactivadas")
